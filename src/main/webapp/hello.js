...
function enableButtons () {
	...
	btn2 = document.getElementById("genpass");
	btn2.onclick=function(){generatePassword();};
...
function generatePassword(){
	var request = gapi.client.helloworldendpoints.generatePassword();
	request.execute(showPassword);
}
